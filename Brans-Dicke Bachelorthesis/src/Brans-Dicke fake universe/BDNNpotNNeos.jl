...
plot3 = Plots.plot(uniquez, EoS2, title="Equation of State, method 2", xlabel="redshift z", ylabel="eos w") #hier ist meine eos die in der diff berechnet wurde
plot4 = Plots.plot(uniquez, V0, title="Potential", xlabel="redshift z", ylabel="V(Ψ)")
...
plot6 = Plots.plot(res[1,:], res[2,:], title= " Ψ' in dependence of Ψ", xlabel = "scalar-field Ψ", ylabel = "Ψ'")
plot7 = Plots.plot(res[1,:], V0, title="Potential in dependence of Ψ", xlabel="scalar field Ψ", ylabel = "V(Ψ)" )
...
savefig(resultplot1,"C:/Jana/Studium/8. sem phys/bachelor/fake universe/NNpot/BDNNpotNNeos1f.png")
savefig(resultplot2,"C:/Jana/Studium/8. sem phys/bachelor/fake universe/NNpot/BDNNpotNNeos2f.png")
#=
savefig(plot1,"C:/Jana/Studium/8. sem phys/bachelor/fake universe/NNpot/BDNNpotNNeos1.png")
savefig(plot2,"C:/Jana/Studium/8. sem phys/bachelor/fake universe/NNpot/BDNNpotNNeos2.png")
savefig(plot3,"C:/Jana/Studium/8. sem phys/bachelor/fake universe/NNpot/BDNNpotNNeos3.png")
savefig(plot4,"C:/Jana/Studium/8. sem phys/bachelor/fake universe/NNpot/BDNNpotNNeos4.png")
savefig(plot5,"C:/Jana/Studium/8. sem phys/bachelor/fake universe/NNpot/BDNNpotNNeos5.png")
savefig(plot6,"C:/Jana/Studium/8. sem phys/bachelor/fake universe/NNpot/BDNNpotNNeos6.png")=#
