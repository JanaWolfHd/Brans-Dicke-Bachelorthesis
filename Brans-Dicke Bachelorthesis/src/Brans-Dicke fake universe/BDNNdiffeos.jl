...
function friedmann!(du,u,p,z)
    ...
    dE = 1.5*E/(1+z)*(1+ ω(Q, p[(length(initial_params(V))+1):end])[1])
...
plot2 = Plots.plot!(plot2, uniquez, y0, label="method 3")
plot4 = Plots.plot(uniquez, V0, title="Potential", xlabel="redshift z", ylabel="V(Ψ)", legend=:bottomright, label="")
...
savefig(resultplot1,"C:/Jana/Studium/8. sem phys/bachelor/fake universe/NNpot/BDNNpotdiffeos1b.png")
savefig(resultplot2,"C:/Jana/Studium/8. sem phys/bachelor/fake universe/NNpot/BDNNpotdiffeos2b.png")
#=
savefig(plot1,"C:/Jana/Studium/8. sem phys/bachelor/fake universe/NNpot/BDNNdiffeos1.png")
savefig(plot2,"C:/Jana/Studium/8. sem phys/bachelor/fake universe/NNpot/BDNNdiffeos2.png")
savefig(plot3,"C:/Jana/Studium/8. sem phys/bachelor/fake universe/NNpot/BDNNdiffeos3.png")
savefig(plot4,"C:/Jana/Studium/8. sem phys/bachelor/fake universe/NNpot/BDNNdiffeos4.png")
savefig(plot5,"C:/Jana/Studium/8. sem phys/bachelor/fake universe/NNpot/BDNNdiffeos5.png")
savefig(plot6,"C:/Jana/Studium/8. sem phys/bachelor/fake universe/NNpot/BDNNdiffeos6.png")=#
