...
function friedmann!(du,u,p,z)
    ...
    Ω_m = 1/3 *(1+z)^3 /E^2 #- Ω_ϕ(Q, dQ, E, V(Q, p), z) # 8pi/3 * (0.5*((1+z)*dQ)^2 + V(Q, p)[1]/E^2)
    # println(Ω_m)
...
omega = 2/3 .*(3 .*res[3,:] .*Enachz .*(1 .+uniquez).^3 .+ 1) ./ (3 .*(1 .+uniquez).^2 .*res[3,:].^2 .- 1) .-1
...
EoSs = FastChain(
    FastDense(1, 8, sigmoid),
    FastDense(8, 8, sigmoid),
...
#plot2 = Plots.plot(uniquez, EoS1, title="Equation of State, method 4", xlabel="redshift z", ylabel="eos w")
plot3 = Plots.plot(uniquez, potential, title="Potential", xlabel="redshift z", ylabel="V(Ψ)", label="")
plot4 = Plots.plot(uniquez, EoSpoly, title="Equation of State", xlabel="redshift z", ylabel="eos w", label="method 1", legend=:bottomright)
plot4 = Plots.plot!(plot4, uniquez, EoSnn, label="method 2" )
plot4 = Plots.plot!(plot4, uniquez, EoS1, label="method 4" )
plot5 = Plots.plot( res[1,:], ϵ, label = "ϵ", title= "Slow- roll parameter" , xlabel = "scalar field Ψ", ylabel = "slow-roll parameter")
...
resultplot1 = Plots.plot(plot1, plot4, layout = (2,1),  size=(1200, 900))
resultplot2 = Plots.plot(plot3, plot7,plot6, plot5, layout = (4,1), size=(1300, 1400))
savefig(resultplot1,"C:/Jana/Studium/8. sem phys/bachelor/real universe/exppot/omega m richtig/BDexppotoutNNeossig1a.png")
savefig(resultplot2,"C:/Jana/Studium/8. sem phys/bachelor/real universe/exppot/omega m richtig/BDexppotoutNNeossig2a.png")
#=
savefig(plot1,"C:/Jana/Studium/8. sem phys/bachelor/real universe/exppot/BDexppotouteos1.png")
savefig(plot2,"C:/Jana/Studium/8. sem phys/bachelor/real universe/exppot/BDexppotouteos2.png")
savefig(plot3,"C:/Jana/Studium/8. sem phys/bachelor/real universe/exppot/BDexppotouteos3.png")
savefig(plot4,"C:/Jana/Studium/8. sem phys/bachelor/real universe/exppot/BDexppotouteos4.png")
savefig(plot5,"C:/Jana/Studium/8. sem phys/bachelor/real universe/exppot/BDexppotouteos5.png")
savefig(plot6,"C:/Jana/Studium/8. sem phys/bachelor/real universe/exppot/BDexppotouteos6.png")=#
