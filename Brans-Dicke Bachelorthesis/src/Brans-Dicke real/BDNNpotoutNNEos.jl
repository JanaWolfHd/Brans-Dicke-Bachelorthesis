...
for epoch ∈ 1:epochs
    ...
    _loss = loss(ps2)
    println("Loss: ", _loss)
    gs = Flux.gradient(p -> loss(p), ps2)[1]
    Flux.Optimise.update!(opt, ps2, gs)
end
...
plot2 = Plots.plot!(uniquez, EoSpoly, label="method 1") 
plot2 = Plots.plot!(uniquez, EoSnn, label="method 2") 
plot4 = Plots.plot(uniquez, V0, title="Potential", xlabel="redshift z", ylabel="V(Ψ)", label="")
...
plot7 = Plots.plot(res[1,:], V0, title="Potential in dependence of Ψ", xlabel="scalar field Ψ", ylabel = "V(Ψ)",label="" )
...
resultplot2 = Plots.plot(plot4, plot7, plot6, plot5, layout = (4,1), size=(1300, 1400))
savefig(resultplot1,"C:/Jana/Studium/8. sem phys/bachelor/real universe/NNpot/omega_m richtig/BDNNpotoutNNeos1f.png")
savefig(resultplot2,"C:/Jana/Studium/8. sem phys/bachelor/real universe/NNpot/omega_m richtig/BDNNpotoutNNeos2f.png")
#=
savefig(plot1,"C:/Jana/Studium/8. sem phys/bachelor/real universe/NNpot/BDNNpotouteos1.png")
savefig(plot2,"C:/Jana/Studium/8. sem phys/bachelor/real universe/NNpot/BDNNpotouteos2.png")
savefig(plot3,"C:/Jana/Studium/8. sem phys/bachelor/real universe/NNpot/BDNNpotouteos3.png")
savefig(plot4,"C:/Jana/Studium/8. sem phys/bachelor/real universe/NNpot/BDNNpotouteos4.png")
savefig(plot5,"C:/Jana/Studium/8. sem phys/bachelor/real universe/NNpot/BDNNpotouteos5.png")
savefig(plot6,"C:/Jana/Studium/8. sem phys/bachelor/real universe/NNpot/BDNNpotouteos6.png")=#
